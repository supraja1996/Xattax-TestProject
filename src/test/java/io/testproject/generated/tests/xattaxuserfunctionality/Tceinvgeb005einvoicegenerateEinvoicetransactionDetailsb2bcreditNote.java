 ...
 * Test: TC_Einv_GEB_005_E-invoice _Generate E-invoice _Transaction Details_B2B_Credit note
 * Generated by: Supraja Nauduri (srilakshmi.supraja@sailotech.com)
 * Generated on Tue Dec 14 12:41:26 GMT 2021.
 */
public class Tceinvgeb005einvoicegenerateEinvoicetransactionDetailsb2bcreditNote implements Test, ExceptionsReporter {
  ...
  public void execute(WebDriver parentDriver) throws Exception {
    ...
    // 5. Select the 'CRN' option in 'invoiceType'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#invoiceType");
    (new Select(driver.findElement(by))).selectByValue("CRN");

    // 6. Generate random number between '1000' and '10000000'
    GeneratedUtils.sleep(500);
    generateNumberInRange = RandomDataGenerator.generateNumberInRange("1000","10000000");
    ...
    */
    ...
    // 43. Select the '3' option in 'gstRate'
    GeneratedUtils.sleep(500);
    by = By.xpath("//div[contains(@class ,\"sales_invoice_box\" )]/descendant::table/descendant::td/div[@class=\"input\"]/select[contains(@name,\"gstRate\")]");
